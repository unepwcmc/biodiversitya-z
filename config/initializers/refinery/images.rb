...
Refinery::Images.configure do |config|
  ...
  config.user_image_sizes = {:small=>"110x110>", :medium=>"225x255>", :large=>"450x450>", :fullwidth=>"800x"}
  ...
  # config.datastore_root_path = "/Applications/MAMP/htdocs/biodiversity/public/system/refinery/images"
